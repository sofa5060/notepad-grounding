...
from notepad_grounding_paper_v2.api import fetch_posts
from notepad_grounding_paper_v2.automation import automate_post
from notepad_grounding_paper_v2.llm import capture_desktop
from notepad_grounding_paper_v2.locate import run_locate

QUERY = "Notepad"
POST_LIMIT = 10
POST_ATTEMPTS = 3
RETRY_DELAY_SECONDS = 1.0
OUTPUT_ROOT = Path("output/notepad_grounding_paper_v2")
